           ...
           <!-- /.row -->
            ...
            ?>
                  ...
                  <div class="form-panel">
                   ...
                   <a target="_blank" class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Print Gaji" href="perintah-print-detail-gaji.php?hal=edit&kd=<?php echo $data['nik'];?>&kd_gaji=<?php echo $data['kd_gaji'];?>"><span class="glyphicon glyphicon-print"></span></a> 
