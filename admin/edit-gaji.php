...
<?php
            $kd = $_GET['kd_gaji'];
			$sql = mysqli_query($koneksi, "SELECT * FROM gajian WHERE kd_gaji='$kd'");
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Data Gaji </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-gaji.php" method="post" enctype="multipart/form-data" name="transfer" id="form1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <option value="Desember">Desember</option>
                              ...
                              <label class="col-sm-3 col-sm-3 control-label">Bulan Gaji Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['gaji_bulan'];?></span>
                              </div>
                          </div>
                          <div class="form-group">
                            ...
                            <label class="col-sm-3 col-sm-3 control-label">Tahun Gaji Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['gaji_tahun'];?></span>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <label class="col-sm-3 col-sm-3 control-label">Transfer Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['tgl_transfer'];?></span>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <label class="col-sm-3 col-sm-3 control-label">Absensi Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['absensi']; ?> Hari Hadir</span>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Sakit</label>
                              <div class="col-sm-3">
                                  <input name="sakit" type="text" id="sakit" class="form-control" autocomplete="off" value="<?php echo $row['sakit'];?>" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Cuti</label>
                              <div class="col-sm-3">
                                  <input name="cuti" type="text" id="cuti" class="form-control" autocomplete="off" value="<?php echo $row['cuti'];?>" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Rek</label>
                              <div class="col-sm-8">
                                  <input name="no_rek" type="text" id="no_rek" class="form-control" autocomplete="off" value="<?php echo $row['no_rek'];?>" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gaji Pokok</label>
                              <div class="col-sm-3">
                            <input name="gaji" type="text" id="gaji" class="form-control" autocomplete="off" value="<?php echo $row['gaji'];?>" autocomplete="off" required />
                            </div>
                          </div>  
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tunjangan</label>
                              <div class="col-sm-3">
                            <input name="tunjangan" type="text" id="tunjangan" class="form-control" value="<?php echo $row['tunjangan'];?>" autocomplete="off" required />
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <label class="col-sm-3 col-sm-3 control-label">Uang Makan Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary">Rp. <?php echo number_format($row['uang_makan'],2,",",".");?></span>
                              </div>
                          </div>
                          <div class="form-group">
                            ...
                            <label class="col-sm-3 col-sm-3 control-label">Uang Transport Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary">Rp. <?php echo number_format($row['uang_transport'],2,",",".");?></span>
                              </div>
                          </div>
                          <div class="form-group">
                            ...
                            <label class="col-sm-3 col-sm-3 control-label">THR Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary">Rp. <?php echo number_format($row['thr'],2,",",".");?></span>
                              </div>
                          </div>
                          <div class="form-group">
                            ...
                            <label class="col-sm-3 col-sm-3 control-label">Gaji Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary">Rp. <?php echo number_format($row['total'],2,",",".");?></span>
                              </div>
                          </div>
                          <div class="form-group">
