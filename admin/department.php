...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari berdasarkan Nik & Nama Dept' required /> 
           ...
           <!-- /.row -->
                  ...
                  <thead>
                    ...
                    <td><center><?php echo $data['kd_dept'];?></center></td>
                    <td><center><a href="detail-karyawan.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data['nik'];?></center></td>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Departement" href="edit-departement.php?hal=edit&kd_dept=<?php echo $data['kd_dept'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nik'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Departement" href="department.php?hal=hapus&kd=<?php echo $data['kd_dept'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
                ...
                <div class="text-right">
                  <a href="input-departement.php" class="btn btn-sm btn-warning">Tambah Departement <i class="fa fa-arrow-circle-right"></i></a>
