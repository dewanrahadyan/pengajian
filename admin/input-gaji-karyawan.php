                      ...
                      <form class="form-horizontal style-form" action="input-gaji-karyawan.php" method="post" enctype="multipart/form-data" name="transfer" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Hadir</label>
                                <div class="col-sm-3">
                                  <input name="hadir" type="number" id="hadir" class="form-control" autocomplete="off" placeholder="Masukkan jumlah hari hadir" required="required"
                                  autofocus="on" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"
                                  />
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Telat</label>
                                <div class="col-sm-3">
                                  <input name="telat" type="number" id="telat" class="form-control" autocomplete="off" placeholder="Masukkan jumlah hari telat" required="required"
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tidak Hadir</label>
                                <div class="col-sm-3">
                                  <input name="tidak_hadir" type="number" id="tidak_hadir" class="form-control" autocomplete="off" placeholder="Masukkan jumlah hari tidak hadir" required="required"
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gaji Pokok</label>
                                <div class="col-sm-3">
                                  <input name="gaji_pokok" type="number" id="" value="<?php echo $data['gaji_pokok']; ?>" class="form-control" autocomplete="off" readonly="readonly" />
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tunjangan Jabatan</label>
                                <div class="col-sm-3">
                                  <input name="tunjangan_jabatan" type="number" id="tunjangan_jabatan" value="<?php echo $data['tunjangan']; ?>" class="form-control" autocomplete="off" readonly="readonly" />
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Premi Hadir</label>
                                <div class="col-sm-3">
                                  <input name="premi_hadir" type="number" id="premi_hadir" class="form-control" autocomplete="off" placeholder="" required="required" readonly="readonly"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tunjangan Konsumsi</label>
                                <div class="col-sm-3">
                                  <input name="tunjangan_konsumsi" type="number" id="tunjangan_konsumsi" class="form-control" autocomplete="off" placeholder="" required="required"
                                  readonly="readonly"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Komisi Penjualan</label>
                                <div class="col-sm-3">
                                  <input name="komisi_penjualan" type="number" id="komisi_penjualan" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Komisi BSC</label>
                                <div class="col-sm-3">
                                  <input name="komisi_bsc" type="number" id="komisi_bsc" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Barang Berkomisi</label>
                                <div class="col-sm-3">
                                  <input name="barang_berkomisi" type="number" id="barang_berkomisi" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tunjangan Jamsostek Tenaga Kerja</label>
                                <div class="col-sm-3">
                                  <input name="tunjangan_jamsostek" type="number" id="tunjangan_jamsostek" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Uang Lembur</label>
                                <div class="col-sm-3">
                                  <input name="uang_lembur" type="number" id="uang_lembur" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gaji Bruto</label>
                                <div class="col-sm-3">
                                  <input name="gaji_bruto" type="number" id="gaji_bruto" class="form-control" autocomplete="off" placeholder="" required="required" readonly="true" />
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Setor ke Jamsostek Tenaga Kerja</label>
                                <div class="col-sm-3">
                                  <input name="setor_jamsostek" type="number" id="setor_jamsostek" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Jamsostek Tenaga Kerja</label>
                                <div class="col-sm-3">
                                  <input name="pot_jamsostek" type="number" id="pot_jamsostek" class="form-control" autocomplete="off" placeholder="" required="required"
                                  onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gaji Netto</label>
                                <div class="col-sm-3">
                                  <input name="gaji_netto" type="number" id="gaji_netto" class="form-control" autocomplete="off" placeholder="" required="required" readonly="true" />
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Telat</label>
                                <div class="col-sm-3">
                                  <input name="pot_telat" type="number" id="pot_telat" class="form-control" autocomplete="off" placeholder="" required="required" readonly="readonly" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Tidak Hadir</label>
                                <div class="col-sm-3">
                                  <input name="pot_tidak_hadir" type="number" id="pot_tidak_hadir" class="form-control" autocomplete="off" placeholder="" required="required" readonly="readonly" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Premi Hadir</label>
                                <div class="col-sm-3">
                                  <input name="pot_premi_hadir" type="number" id="pot_premi_hadir" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan ITU</label>
                                <div class="col-sm-3"> 
                                  <input name="pot_itu" type="number" id="pot_itu" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Iuran Wajib</label>
                                <div class="col-sm-3">
                                  <input name="pot_iuran_wajib" type="number" id="pot_iuran_wajib" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Iuran Sukarela</label>
                                <div class="col-sm-3">
                                  <input name="pot_iuran_sukarela" type="number" id="pot_iuran_sukarela" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Potongan Iuran Koperasi</label>
                                <div class="col-sm-3">
                                  <input name="pot_iuran_koperasi" type="number" id="pot_iuran_koperasi" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Biaya Administrasi Payroll</label>
                                <div class="col-sm-3">
                                  <input name="biaya_adm" type="number" id="biaya_adm" class="form-control" autocomplete="off" placeholder="" required="required" onkeyup="hitung_gaji()" onkeydown="hitung_gaji()" onchange="hitung_gaji()"/>
                                </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Take Home Pay</label>
                                <div class="col-sm-3">
                                  <input name="take_home_pay" type="number" id="take_home_pay" class="form-control" autocomplete="off" placeholder="" required="required" readonly="true" />
                                </div>
                          </div>
