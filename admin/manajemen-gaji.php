                 ...
                 //  $caridepartemen = $_GET['caridepartemen'];
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Karyawan" href="edit-karyawan.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                      <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Karyawan" href="karyawan.php?hal=hapus&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-trash"></a></center>
                      </td>
                    </tr>
                    </div>
                 <?php   
